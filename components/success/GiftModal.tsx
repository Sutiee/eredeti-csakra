 ...
 * Second modal in the success page upsell sequence
 * Displays after the workbook upsell modal (2-second delay)
 * Offers gift purchase options based on workbook purchase decision
 */
...
export default function GiftModal({
  ...
  }, [onClose, trackEvent, resultId, sessionId, productId, workbookPurchased]);
    ...
    try {
      ...
      const response = await fetch('/api/upsell/process', {
        ...
        body: JSON.stringify({
          ...
          // TODO: Collect recipient email and message in form
          ...
          {!purchased ? (
            <>
              ...
              <div className="text-center mb-6">
                ...
                >
                  🎁 Ajándékozz spirituális útmutatást!
                </motion.h2>
                <motion.p
                ...
                >
                  Exkluzív ajándék ajánlat - <strong>CSAK MOST</strong> elérhető!
                </motion.p>
              </div>
              ...
              <motion.div
                className="bg-gradient-to-r from-purple-100 to-pink-100 rounded-lg p-4 mb-6"
                initial={{ scale: 0.9, opacity: 0 }}
                animate={{ scale: 1, opacity: 1 }}
              ...
              >
                ...
                >
                  {loading ? (
                    ...
                    <>
                      <span>🎁 IGEN, AJÁNDÉKBA VESZEM!</span>
                    </>
                  )}
                </button>
              ...
              >
                🌟 A tökéletes ajándék spirituális fejlődéshez
              </motion.p>
            </>
          ) : (
            // Success state
            ...
            >
              ...
              <p className="text-gray-700">
                Az <strong>{productName}</strong> ajándék kódot hamarosan megkapod emailben.
              </p>
