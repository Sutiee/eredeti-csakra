/**
 * Test Styled Markdown → PDF Pipeline
 * Tests beautiful chakra-colored PDF generation
 */
...
// Styled Markdown with HTML classes
const cachedStyledMarkdown = `
...
1. **Földeltség és biztonságérzet megerősítése** - A gyökércsakra stabilizálása elengedhetetlen az általános egyensúly megteremtéséhez
2. **Személyes hatalom és önbizalom kiegyensúlyozása** - A napfonat csakra erősítése segít az önérvényesítésben
3. **Kommunikáció és belső tisztaság harmonizálása** - A torok csakra fejlesztése hozzájárul az őszinte kifejezéshez
...
1. **Én biztonságban vagyok a jelenben** - Ez az afirmáció a biztonság érzését építi
2. **Én megengedem magamnak a pihenést és gyógyulást** - Önmagad gondozásának engedélyezése
3. **Én stabil alapokat építek belső erőmből** - Belső erőforrásaid aktiválása
4. **Én értékelem testem jelzéseit** - A test-lélek kapcsolat megerősítése
5. **Én megérdemlem az anyagi biztonságot** - Bőség-tudatosság fejlesztése
...
1. **Én megengedem magamnak az örömöt** - Az öröm megengedése nélkülözhetetlen
2. **Én tisztelem érzelmeimet és vágyaimat** - Érzelmi önelfogadás erősítése
3. **Én biztonságosan kifejezhetem szenvedélyemet** - Szenvedély felszabadítása
4. **Én kreatív energiáimhoz kapcsolódom** - Kreatív forrásaid aktiválása
5. **Én elfogadom érzékenységemet** - Érzékenység mint erősség
...
1. **Én értékes vagyok önmagamért** - Feltétel nélküli önelfogadás
2. **Én képes vagyok dönteni és cselekedni** - Döntéshozatali képesség erősítése
3. **Én vállalom személyes erőmet békével** - Belső hatalom elismerése
4. **Én elfogadom hibáimat tanulásként** - Hiba mint tanulási lehetőség
5. **Én megengedem magamnak a siker érzését** - Siker megengedése
...
1. **Én szeretettel közelítek önmagamhoz és másokhoz** - Kiegyensúlyozott szeretet
2. **Én megengedem a szeretet befogadását** - Adás és kapás egyensúlya
3. **Én tartom és tisztelem a saját határaimat** - Egészséges határok
4. **Én együttérzéssel viszonyulok a világhoz** - Compassion practice
5. **Én kapcsolódok békés szívvel** - Belső béke megtartása
...
1. **Én kifejezem igazamat tisztelettel** - Őszinte, tiszteletteljes kommunikáció
2. **Én engedem szavakat találni a belső igazságomra** - Autentikus hang
3. **Én hangom valódi és értékes** - A hang erejének elismerése
4. **Én nyitottan hallgatok és beszélek** - Kétirányú kommunikáció
5. **Én megengedem az őszinte kifejezést** - Igazság kimondása
...
1. **Én bízhatok belső bölcsességemben** - Intuíció megerősítése
2. **Én tisztán látom belső igazságaimat** - Belső látás fejlesztése
3. **Én hallgatom meg az intuícióm hangját** - Intuíció követése
4. **Én értelmezem az élet jeleit békével** - Jel-értelmezés
5. **Én engedem a belső képeket vezetni** - Vizuális intuíció
...
1. **Én kapcsolódom a felsőbb bölcsességhez** - Spirituális kapcsolat
2. **Én befogadom a transzcendens útmutatást** - Isteni vezetés
3. **Én érzem az egység és egészség jelenlétét** - Egység-tapasztalat
4. **Én hálás vagyok a belső világomért** - Hála gyakorlása
5. **Én nyitott vagyok a magasabb látásra** - Spirituális látás
...
**Földelő Séta Meditáció**: Minden nap 15-20 percet sétálj mezítláb természetben (fű, föld, homok). Érezd a lábadat a földön, figyelj minden lépésre. Képzeld el, hogy gyökerek nőnek lábaidból a földbe, amelyek táplálják és stabilizálják tested.

</div>

<div class="exercise-card">

**Biztonság Naplózás**: Írj le minden este 3 dolgot, ami aznap biztonságot adott neked (tető a fejed felett, étkezés, meleg ágy). Ez átprogramozza a tudatalattit a biztonság érzésére.

</div>

<div class="exercise-card">

**Vörös Étel Rituálé**: Fogyassz tudatosan vörös ételeket (cékla, paradicsom, piros paprika) és közben afirmáld: "Én táplálom a gyökereimet, erős és biztonságos vagyok."
...
**Napfelkelte Gyakorlat**: Minden reggel 5 percet állj a napfényben (vagy ablak mellett), tenyeredet hasadra helyezve. Lélegezz mélyen, képzeld el, ahogy a napfény arany energiája tölti meg hasadat. Mondd: "Én vagyok az én életem teremtője."

</div>

<div class="exercise-card">

**Kis Győzelmek Listája**: Készíts listát 20 dologról, amit jól csinálsz (akár kicsi dolgok: jó kávét főzöl, időben megérkezel, empatikus vagy). Olvasd fel magadnak hangosan hetente.

</div>

<div class="exercise-card">

**Sárga Ruházat Nap**: Válassz egy napot hetente, amikor sárga színt viselsz (ruha, sál, ékszer). Ez aktiválja a napfonat energiáját és emlékeztet a belső napsugárodra.
...
**Hangoztatás Gyakorlat**: Reggel 5 percig dalolj, zümmögj vagy ismételj mantrákat (pl. "HAM" - torok csakra bija mantra). Érezd a rezgést a torkodon.

</div>

<div class="exercise-card">

**Őszinteség Napló**: Írj le minden este egy dolgot, amit nem mondtál ki aznap, de szerettél volna. Gyakorold a papíron az őszinte kifejezést ítélet nélkül.

</div>

<div class="exercise-card">

**Kék Meditáció**: Viselj kék követ (türkiz, akvamarín) a nyakadban és naponta képzeld el, hogy kék fény áramlik torkodon keresztül, tisztítva és felszabadítva hangod.
...
async function testStyledMarkdownToPDF() {
  console.log('🎨 Testing STYLED Markdown → PDF Pipeline with Cached Data...\n');

  console.log('📊 Using cached STYLED Markdown report');
  console.log('  User: Teszt Mária');
  console.log('  Email: maria@teszt.hu');
  console.log('  Features: Chakra colors, page breaks, styled boxes\n');

  console.log('⏳ Converting STYLED Markdown to PDF...');
  const startTime = Date.now();

  const pdfBuffer = await convertStyledMarkdownToPDF(
    cachedStyledMarkdown,
    sampleChakraScores,
    'Teszt Mária',
    'maria@teszt.hu'
  );
  ...
  // Save PDF
  const outputPath = '/Users/szabolaszlo/Library/CloudStorage/SynologyDrive-DRIVE/Appok/EredetiCsakra/test-styled-markdown.pdf';
  fs.writeFileSync(outputPath, pdfBuffer);

  console.log('✅ STYLED PDF generated in ' + duration + 's\n');
  console.log('📊 Statistics:');
  console.log('  PDF Size: ' + (pdfBuffer.length / 1024).toFixed(2) + ' KB');
  console.log('  Markdown Length: ' + cachedStyledMarkdown.length + ' chars');
  console.log('  Output File: ' + outputPath + '\n');

  console.log('🎉 Test STYLED PDF saved successfully!');
  console.log('🌈 Features: Chakra colors, page breaks, styled boxes');
  console.log('\nOpen it with: open ' + outputPath);
}

testStyledMarkdownToPDF().catch(console.error);
